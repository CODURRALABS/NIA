...
import { getNiaSettings, NiaSettings } from "@/lib/supabaseSettings";
...
export default function LandingPortal() {
        ...
        try {
            const res = await fetch('/api/tts', {
                ...
                body: JSON.stringify({
                    ...
                    speaker: settings?.voice_id || 'meera',
            ...
            if (data.audio) {
                ...
                audio.play().catch(e => console.warn("Greeting blocked", e));
            }
        } catch (err) {
    ...
    const handleEnter = async () => {
        ...
        speakGreeting();
        // Add a delay before routing to allow the animation
        setTimeout(() => {
            router.push("/personalization?from_portal=true");
        }, 1500);
    };
    ...
    useEffect(() => {
        ...
        const handleMouseMove = (e: MouseEvent) => {
            mouse.targetX = e.clientX / canvas.width;
            mouse.targetY = 1.0 - e.clientY / canvas.height;
        };
    ...
    return (
        <div className="relative w-full h-screen bg-black overflow-hidden font-sans">
            ...
            <div className="content-overlay">
                <h1 className="main-title">NIA</h1>
                <p className="tagline">Sovereign Living Assistant</p>
                <div className="buttons-container">
                    ...
                    >
                        ...
                        <span>{transitioning ? "INITIALIZING..." : "ENTER NIA"}</span>
                    </button>
                    <button
                        className="glass-button"
                        onMouseMove={handleButtonMouseMove}
            ...
            {/* Transition Overlay */}
            <div
                className="absolute inset-0 bg-white z-50 pointer-events-none transition-all duration-[1500ms] ease-in-out"
                style={{
