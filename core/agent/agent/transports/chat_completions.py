...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate NIA/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from NIA'
    ...
    # is stricter (low/high). Clamp NIA' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        if is_nous:
            extra_body["tags"] = ["product=nia-agent"]
