...
(3 SDK retries x 3 NIA retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".nia")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, NIA, ...) behind one endpoint.  A 429 can mean either:
