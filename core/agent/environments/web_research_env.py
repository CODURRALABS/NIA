...
Inspired by: GroceryMind — production NIA doing live web research
             across German grocery stores (firecrawl + nia-agent)
"""
...
# Ensure nia-agent root is on path
...
class WebResearchEnvConfig(NIAAgentEnvConfig):
...
class WebResearchEnv(NIAAgentBaseEnv):
    """
