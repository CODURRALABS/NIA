...
Same as NIA but uses <longcat_tool_call> tags instead of <tool_call>.
Based on VLLM's LongcatFlashToolParser (extends NIA2ProToolParser).
"""
...
class LongcatToolCallParser(ToolCallParser):
    ...
    Identical logic to NIA, just different tag names.
    """
