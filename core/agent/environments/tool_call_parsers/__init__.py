...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("nia")
        class NIAToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "nia", "mistral", "llama3_json")
...
from environments.tool_call_parsers.nia_parser import NIAToolCallParser  # noqa: E402, F401
