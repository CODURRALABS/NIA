...
ALL nia-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all nia-agent tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any nia-agent tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("NIA_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("NIA_QUIET", None)
            else:
                os.environ["NIA_QUIET"] = _prev_quiet
