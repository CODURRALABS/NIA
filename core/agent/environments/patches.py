"""
Monkey patches for making nia-agent tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by nia_base_env.py).
