"""
NIASweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser nia
    run-api
    python environments/nia_swe_env.py serve \\
...
class NIASweEnv(NIAAgentBaseEnv):
    ...
    name = "nia-swe"
    env_config_cls = NIASweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[NIASweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = NIASweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepNIA-3-Llama-3-3B-Preview",
            tool_call_parser="nia",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="nia-swe",
        ...
        server_configs = [
            APIServerConfig(
                ...
                model_name="NousResearch/DeepNIA-3-Llama-3-3B-Preview",
