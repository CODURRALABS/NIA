...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the NIA documentation based on your experience level and goals.'
---

# Learning Path

NIA can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed NIA yet, begin with the [Installation guide](/docs/getting-started/installation) and then run through the [Quickstart](/docs/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything NIA can do.
...
Use NIA as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. NIA can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy NIA as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with NIA](/docs/guides/use-voice-mode-with-nia)
...
:::tip
Cron jobs let NIA run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::

### "I want to build custom tools/skills"

Extend NIA with your own tools and reusable skill packages.

1. [Plugins](/docs/user-guide/features/plugins)
2. [Build a NIA Plugin](/docs/guides/build-a-nia-plugin)
...
page is for built-in NIA core development, not the usual user/custom-tool path.
:::

### "I want to train models"

Use reinforcement learning to fine-tune model behavior with NIA's built-in RL training pipeline.
...
:::tip
RL training works best when you already understand the basics of how NIA handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate NIA into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call NIA tools programmatically | [Code Execution](/docs/user-guide/features/code-execution) |
