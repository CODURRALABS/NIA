...
| [`nia-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nia-agent) | Configure, extend, or contribute to NIA. | `autonomous-ai-agents/nia-agent` |
...
| [`kanban-worker`](/docs/user-guide/skills/bundled/devops/devops-kanban-worker) | Pitfalls, examples, and edge cases for NIA Kanban workers. The lifecycle itself is auto-injected into every worker's system prompt as KANBAN_GUIDANCE (from agent/prompt_builder.py); this skill is what you load when you want deeper det... | `devops/kanban-worker` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`debugging-nia-tui-commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-nia-tui-commands) | Debug NIA TUI slash commands: Python, gateway, Ink UI. | `software-development/debugging-nia-tui-commands` |
| [`nia-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-nia-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/nia-agent-skill-authoring` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write markdown plan to .nia/plans/, no exec. | `software-development/plan` |
