...
| | |
|---|---|
| Source | Optional — install with `nia skills install official/health/neuroskill-bci` |
...
Connect NIA to a running [NeuroSkill](https://neuroskill.com/) instance to read
