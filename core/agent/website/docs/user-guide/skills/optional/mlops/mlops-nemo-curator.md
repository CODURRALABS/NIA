...
| | |
|---|---|
| Source | Optional — install with `nia skills install official/mlops/nemo-curator` |
...
- **[Filtering Guide](Local Sovereign Environment/blob/main/optional-skills/mlops/nemo-curator/references/filtering.md)** - 30+ quality filters, heuristics
- **[Deduplication Guide](Local Sovereign Environment/blob/main/optional-skills/mlops/nemo-curator/references/deduplication.md)** - Exact, fuzzy, semantic methods
