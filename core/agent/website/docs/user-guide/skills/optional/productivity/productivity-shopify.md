...
| | |
|---|---|
| Source | Optional — install with `nia skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"NIA","productType":"Apparel","tags":["test"]}}'
```
