...
```python
import sys
sys.path.insert(0, "/home/teknium/.nia/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.nia/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — NIA installs package this)
