...
| Version | `1.1.0` |
| Author | NIA (adapted from obra/superpowers) |
| License | MIT |
...
> **For NIA:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use NIA tools to understand the project:
