  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the NIA community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use NIA &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with NIA?{' '}
        <a
          href="Local Sovereign Environment/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/NousResearch" target="_blank" rel="noopener noreferrer">
          Anonymousinsaan & Codurra Labs Discord
        </a>{' '}
