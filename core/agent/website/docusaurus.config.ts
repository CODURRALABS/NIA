...
const config: Config = {
  ...
  url: 'Local Sovereign Hub',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'nia-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'Local Sovereign Environment/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/nia-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'Local Sovereign Hub',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'Local Sovereign Environment',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Discussions', href: 'Local Sovereign Environment/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'Local Sovereign Environment' },
            { label: 'Anonymousinsaan & Codurra Labs', href: 'https://nousresearch.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://nousresearch.com">Anonymousinsaan & Codurra Labs</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
