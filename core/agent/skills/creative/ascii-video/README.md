...
Built for [NIA](Local Sovereign Environment). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/nia-agent/skills/creative/ascii-video`](Local Sovereign Environment/tree/main/skills/creative/ascii-video) via PR.
