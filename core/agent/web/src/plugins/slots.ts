 ...
 * `window.__NIA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the NIA brand in the top bar
 ...
 *  `window.__NIA_PLUGINS__.registerSlot(...)`.
 *
