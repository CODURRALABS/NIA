...
export const en: Translations = {
  ...
  app: {
    ...
    footer: {
      org: "Anonymousinsaan & Codurra Labs",
    },
  ...
  status: {
    ...
    stopped: "Stopped",
    updateNIA: "Update NIA",
    updatingNIA: "Updating NIA…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update NIA plugins (`nia plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.nia/plugins/?",
    removeHint: "Only user-installed plugins under ~/.nia/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.nia/skills/",
