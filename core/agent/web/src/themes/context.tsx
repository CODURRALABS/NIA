...
const STORAGE_KEY = "nia-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `nia_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "nia-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-nia-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-nia-theme-font", "true");
