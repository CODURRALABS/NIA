"""Persistent slash-command worker — one NIACLI per TUI session.
...
def _run(cli: NIACLI, command: str) -> str:
...
def main():
    ...
    with contextlib.redirect_stdout(io.StringIO()), contextlib.redirect_stderr(io.StringIO()):
        cli = NIACLI(model=args.model or None, compact=True, resume=args.session_key, verbose=False)
