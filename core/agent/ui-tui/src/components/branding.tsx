import { Box, Text, useStdout } from '@nia/ink'
    ...
    <Box flexDirection="column" marginBottom={1}>
      {cols >= (t.bannerLogo ? artWidth(logoLines) : LOGO_WIDTH) ? (
        ...
        <Text bold color={t.color.primary}>
          {t.brand.icon} NOUS NIA
        </Text>
      )}

      <Text color={t.color.muted}>{t.brand.icon} Anonymousinsaan & Codurra Labs · Messenger of the Digital Gods</Text>
    </Box>
  )
}
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · Anonymousinsaan & Codurra Labs</Text>
          </Text>
      ...
      <Box flexDirection="column" width={w}>
        ...
        {typeof info.update_behind === 'number' && info.update_behind > 0 && (
          <Text bold color={t.color.warn}>
            ...
            <Text bold color={t.color.warn}>
              {info.update_command || 'nia update'}
            </Text>
            <Text bold={false} color={t.color.warn} dimColor>
              {' '}
              to update
