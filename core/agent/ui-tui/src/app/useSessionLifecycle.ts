...
import type { ScrollBoxHandle } from '@nia/ink'
import { evictInkCaches } from '@nia/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.NIA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
