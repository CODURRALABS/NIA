"""
Email platform adapter for the NIA gateway.

Allows users to interact with NIA by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        msg_id = f"<nia-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
