...
Config: ~/.nia/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.nia/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_nia_home()`` helper (NIA_HOME-aware and
...
RULES_FILE = get_nia_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_nia_home() / "feishu_comment_pairing.json"
