...
def _enable_managed_nous_tools(monkeypatch):
    ...
    nia_cli.auth and nia_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("nia_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("nia_cli.models.check_nous_free_tier", lambda: False)
