...
class TestParserRegistry:
    ...
    def test_nia_parser_registered(self):
        parsers = list_parsers()
        assert "nia" in parsers
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["nia"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use nia format since that's universal
