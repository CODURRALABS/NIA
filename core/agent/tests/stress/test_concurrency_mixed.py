...
def worker_loop(worker_id: int, nia_home: str, result_file: str) -> None:
...
def reclaimer_loop(nia_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="nia_mixed_stress_")
    print(f"NIA_HOME = {home}")
