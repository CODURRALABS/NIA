...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("nia_logging.setup_logging", lambda nia_home, mode: tmp_path)
    monkeypatch.setattr("nia_logging._add_rotating_handler", lambda *args, **kwargs: None)
