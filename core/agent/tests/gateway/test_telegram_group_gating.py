...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @nia_bot", entities=[_mention_entity("hi @nia_bot")])) is True
    ...
    assert adapter._should_process_message(
        _group_message(
            "/status@nia_bot",
            entities=[_bot_command_entity("/status@nia_bot", "/status@nia_bot")],
        ),
        is_command=True,
    ) is True
