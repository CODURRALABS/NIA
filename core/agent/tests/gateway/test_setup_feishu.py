"""Tests for _setup_feishu() in nia_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("nia_cli.gateway.save_env_value", side_effect=mock_save), \
         patch("nia_cli.gateway.get_env_value", side_effect=mock_get), \
         patch("nia_cli.gateway.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("nia_cli.gateway.prompt_choice", side_effect=prompt_choice_responses), \
         patch("nia_cli.gateway.prompt", side_effect=prompt_responses), \
         patch("nia_cli.gateway.print_info"), \
         patch("nia_cli.gateway.print_success"), \
         patch("nia_cli.gateway.print_warning"), \
         patch("nia_cli.gateway.print_error"), \
         patch("nia_cli.gateway.color", side_effect=lambda t, c: t), \
         patch("gateway.platforms.feishu.qr_register", return_value=qr_result):

        from nia_cli.gateway import _setup_feishu
        _setup_feishu()
