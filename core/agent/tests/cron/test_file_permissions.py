...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("nia_cli.config.get_config_path", return_value=config_path), \
             patch("nia_cli.config.ensure_nia_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("nia_cli.config.get_env_path", return_value=env_path), \
             patch("nia_cli.config.ensure_nia_home"):
    ...
    def test_ensure_nia_home_sets_0700(self):
        home = Path(self.tmpdir) / ".nia"
        with patch("nia_cli.config.get_nia_home", return_value=home):
