...
See: Local Sovereign Environment/issues/4426
"""
...
class TestGetSubprocessHome:
    """Unit tests for nia_constants.get_subprocess_home()."""

    def test_returns_none_when_nia_home_unset(self, monkeypatch):
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("NIA_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("NIA_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_injects_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["HOME"] == str(nia_home / "home")
    ...
    def test_no_injection_when_nia_home_unset(self, monkeypatch):
        monkeypatch.delenv("NIA_HOME", raising=False)
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from nia_cli.profiles import _PROFILE_DIRS
    ...
    def test_create_profile_bootstraps_home_dir(self, tmp_path, monkeypatch):
        ...
        from nia_cli.profiles import create_profile
