...
NIA_OVERLAYS keys may be models.dev IDs (e.g. "github-copilot") while
_PROVIDER_MODELS and config.yaml use NIA IDs ("copilot").  The slug
...
def test_copilot_uses_nia_slug():
...
def test_kimi_for_coding_overlay_uses_nia_slug():
...
def test_kilo_overlay_uses_nia_slug():
