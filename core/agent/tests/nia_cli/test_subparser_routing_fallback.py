...
The main() function in nia_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `nia -c model`
...
def _build_parser():
    """Build a minimal replica of the nia top-level parser."""
