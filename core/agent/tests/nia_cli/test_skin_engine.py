"""Tests for nia_cli.skin_engine — the data-driven skin/theme system."""
...
def reset_skin_state():
    ...
    from nia_cli import skin_engine
...
class TestSkinConfig:
    def test_default_skin_has_required_fields(self):
        from nia_cli.skin_engine import load_skin
    ...
    def test_get_branding_with_fallback(self):
        from nia_cli.skin_engine import load_skin
        skin = load_skin("default")
        assert skin.get_branding("agent_name") == "NIA"
...
class TestBuiltinSkins:
    ...
    def test_all_builtin_skins_have_complete_colors(self):
        from nia_cli.skin_engine import _BUILTIN_SKINS, _build_skin_config
...
class TestSkinManagement:
    def test_set_active_skin(self):
        from nia_cli.skin_engine import set_active_skin, get_active_skin, get_active_skin_name
    ...
    def test_init_skin_from_config(self):
        from nia_cli.skin_engine import init_skin_from_config, get_active_skin_name
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        from nia_cli.skin_engine import load_skin, _skins_dir
        ...
        # Patch skins dir
        monkeypatch.setattr("nia_cli.skin_engine._skins_dir", lambda: skins_dir)
...
class TestDisplayIntegration:
    ...
    def test_get_skin_tool_prefix_custom(self):
        from nia_cli.skin_engine import set_active_skin
        from agent.display import get_skin_tool_prefix
...
class TestCliBrandingHelpers:
    ...
    def test_active_prompt_symbol_ares(self):
        from nia_cli.skin_engine import set_active_skin, get_active_prompt_symbol

        set_active_skin("ares")
        assert get_active_prompt_symbol() == "⚔ "

    def test_active_help_header_ares(self):
        from nia_cli.skin_engine import set_active_skin, get_active_help_header

        set_active_skin("ares")
        assert get_active_help_header() == "(⚔) Available Commands"

    def test_active_goodbye_ares(self):
        from nia_cli.skin_engine import set_active_skin, get_active_goodbye

        set_active_skin("ares")
        assert get_active_goodbye() == "Farewell, warrior! ⚔"

    def test_prompt_toolkit_style_overrides_cover_tui_classes(self):
        from nia_cli.skin_engine import set_active_skin, get_prompt_toolkit_style_overrides
        set_active_skin("ares")
    ...
    def test_prompt_toolkit_style_overrides_use_skin_colors(self):
        from nia_cli.skin_engine import (
            set_active_skin,
            get_active_skin,
