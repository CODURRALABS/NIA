...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from nia_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in NIA_OVERLAYS
        overlay = NIA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify nia doctor recognizes Xiaomi env vars."""
