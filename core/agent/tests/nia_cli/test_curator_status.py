"""Tests for `nia curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import nia_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated NIA_HOME with real agent-created skills on disk."""
    home = tmp_path / ".nia"
    skills = home / "skills"
    ...
    from nia_cli import curator as curator_cli
