"""Tests for the interactive session browser (`nia sessions browse`).
...
from nia_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """nia sessions browse should be parseable."""
        from nia_cli.main import main as _main_entry
