"""Tests for MCP tools interactive configuration in nia_cli.tools_config."""

from types import SimpleNamespace
from unittest.mock import MagicMock, patch

from nia_cli.tools_config import _configure_mcp_tools_interactive

# Patch targets: imports happen inside the function body, so patch at source
_PROBE = "tools.mcp_tool.probe_mcp_server_tools"
_CHECKLIST = "nia_cli.curses_ui.curses_checklist"
_SAVE = "nia_cli.tools_config.save_config"
