"""Tests for nia tools disable/enable/list command (backend)."""
...
class TestToolsDisableBuiltin:
    ...
    def test_disable_removes_toolset_from_platform(self):
        ...
        with patch("nia_cli.tools_config.load_config", return_value=config), \
             patch("nia_cli.tools_config.save_config") as mock_save:
