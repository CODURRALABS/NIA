...
class TestMem0FiltersV2:
    ...
    def test_write_filters_include_agent_id(self):
        ...
        provider._user_id = "u123"
        provider._agent_id = "nia"
        assert provider._write_filters() == {"user_id": "u123", "agent_id": "nia"}
...
class TestMem0Defaults:
    ...
    def test_default_user_id_nia_user(self, monkeypatch, tmp_path):
        ...
        assert provider._user_id == "nia-user"

    def test_default_agent_id_nia(self, monkeypatch, tmp_path):
        monkeypatch.setenv("MEM0_API_KEY", "test-key")
