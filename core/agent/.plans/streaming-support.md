# Streaming LLM Response Support for NIA
...
```
NIA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("NIA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `nia_cli/config.py` | 1 | +streaming config defaults |
