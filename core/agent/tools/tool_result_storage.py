...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/nia-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/nia-results/{tool_use_id}.txt on Termux)
...
STORAGE_DIR = "/tmp/nia-results"
HEREDOC_MARKER = "NIA_PERSIST_EOF"
...
def _heredoc_marker(content: str) -> str:
    ...
    return f"NIA_PERSIST_{uuid.uuid4().hex[:8]}"
