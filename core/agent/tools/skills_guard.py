...
Trust levels:
  - builtin:   Ships with NIA. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.nia/\.env|\~/\.nia/\.env',
     "nia_env_access", "critical", "exfiltration",
     "directly references NIA secrets file"),
    ...
    (r'\.nia/config\.yaml|\.nia/SOUL\.md',
     "nia_config_mod", "critical", "persistence",
     "references NIA configuration files directly"),
