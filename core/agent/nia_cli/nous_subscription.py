...
from nia_cli.config import get_env_value, load_config
...
def get_nous_subscription_features(
    ...
    # Tool Gateway via `nia model`, so direct credentials should NOT
...
def prompt_enable_tool_gateway(config: Dict[str, object]) -> set[str]:
    ...
    try:
        from nia_cli.setup import prompt_choice
    except Exception:
        return set()
