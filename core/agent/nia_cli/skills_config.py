"""
Skills configuration for NIA.
`nia skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.nia/config.yaml under:
...
from nia_cli.config import cfg_get, load_config, save_config
from nia_cli.colors import Colors, color
from nia_cli.platforms import PLATFORMS as _PLATFORMS
