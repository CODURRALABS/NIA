"""NIA CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.nia/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "NIA"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ NIA "       # Response box header label
...
.. code-block:: python
    ...
    from nia_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "NIA"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.nia/skins/
...
Drop a YAML file in ``~/.nia/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces NIA_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces NIA_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic NIA — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "NIA",
            "welcome": "Welcome to NIA! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ NIA ",
            "prompt_symbol": "❯",
