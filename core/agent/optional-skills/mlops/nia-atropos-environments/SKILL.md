---
name: nia-atropos-environments
description: Build, test, and debug NIA RL environments for Atropos training. Covers the NIAAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the nia-agent repo.
version: 1.1.0
author: NIA
license: MIT
metadata:
