...
Data file: $NIA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_NIA_HOME = Path(os.environ.get("NIA_HOME", Path.home() / ".nia"))
DATA_DIR = _NIA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
