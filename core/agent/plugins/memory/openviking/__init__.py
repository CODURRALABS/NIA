...
Config via environment variables (profile-scoped via each profile's .env):
  ...
  OPENVIKING_AGENT   — Tenant agent (default: nia)
...
class _VikingClient:
    ...
    def __init__(self, endpoint: str, api_key: str = "",
        ...
        self._agent = agent or os.environ.get("OPENVIKING_AGENT", "nia")
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        return [
            ...
            {
                "key": "agent",
                "description": "OpenViking agent ID within the account ([nia], useful in multi-agent mode)",
                "default": "nia",
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._agent = os.environ.get("OPENVIKING_AGENT", "nia")
    ...
    def _tool_read(self, args: dict) -> str:
        ...
        # (e.g. viking://user/nia/.overview.md).
