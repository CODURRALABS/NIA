(function () {
  "use strict";
  // nia-achievements dashboard plugin
  // Originally authored by @PCinkusz — https://github.com/PCinkusz/nia-achievements (MIT).
  // Bundled into nia-agent. Upstream repo remains the staging ground for new
  ...
  if (!SDK || !window.__NIA_PLUGINS__) return;
  ...
  async function api(path, options) {
    const url = "/api/plugins/nia-achievements" + path;
  ...
  async function buildShareImage(achievement) {
    ...
    ctx.fillText("NIA  ·  nia-agent.nousresearch.com", 70, H - 40);
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function download() {
      ...
      a.href = url;
      a.download = "nia-achievement-" + (achievement.id || "badge") + ".png";
    ...
    function tweetText() {
      ...
      return "Just unlocked " + tierPart + "\"" + achievement.name + "\" in NIA ☤\n\n" +
        "@NousResearch · Local Sovereign Hub";
    }
    ...
    return React.createElement("div", { className: "ha-page ha-page-loading" },
      React.createElement("section", { className: "ha-hero ha-loading-hero" },
        React.createElement("div", null,
          ...
          React.createElement("h1", null, "NIA Achievements"),
          React.createElement("p", null, "Scanning NIA session history. First scan can take 5–10 seconds on large histories.")
        ),
      ...
      React.createElement("section", { className: "ha-guide ha-loading-guide" },
        React.createElement("div", null,
          ...
          React.createElement("p", null, "NIA is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.")
        ),
        React.createElement("div", null,
    ...
    return React.createElement("div", { className: "ha-page" },
      React.createElement("section", { className: "ha-hero" },
        React.createElement("div", null,
          React.createElement("div", { className: "ha-kicker" }, "Agentic Gamerscore"),
          React.createElement("h1", null, "NIA Achievements"),
          React.createElement("p", null, "Collectible NIA badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.")
        ),
      ...
      React.createElement("div", { className: "ha-stats" },
        ...
        React.createElement(StatCard, { label: "Latest", value: latest[0] ? latest[0].name : "None yet", hint: latest[0] ? latest[0].category : "run NIA more" })
      ),
      React.createElement("section", { className: "ha-guide" },
        ...
        React.createElement("div", null,
          ...
          React.createElement("p", null, "Secrets hide their exact trigger. Once NIA sees a related signal, the card becomes Discovered and shows its requirement.")
        )
      ),
  ...
  window.__NIA_PLUGINS__.register("nia-achievements", AchievementsPage);
})();
