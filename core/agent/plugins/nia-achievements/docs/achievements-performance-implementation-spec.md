# NIA Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.nia/plugins/nia-achievements/state.json` (existing unlock state)
  - `~/.nia/plugins/nia-achievements/scan_snapshot.json` (new)
  - `~/.nia/plugins/nia-achievements/scan_checkpoint.json` (new)
