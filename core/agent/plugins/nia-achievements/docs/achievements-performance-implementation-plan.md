# NIA Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.nia/plugins/nia-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.nia/plugins/nia-achievements/scan_checkpoint.json`.
