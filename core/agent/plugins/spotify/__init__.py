...
``_check_spotify_available()`` — when the user has not run ``nia auth
spotify``, the tools remain registered (so they appear in ``nia
...
The Spotify auth flow (``nia auth spotify``), CLI plumbing, and docs
