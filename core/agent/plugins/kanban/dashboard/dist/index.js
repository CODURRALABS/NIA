/**
 * NIA Kanban — Dashboard Plugin
 *
 * Board view for the multi-agent collaboration board backed by
 * ~/.nia/kanban.db. Calls the plugin's backend at /api/plugins/kanban/
 * and tails task_events over a WebSocket for live updates.
 *
 * Plain IIFE, no build step. Uses window.__NIA_PLUGIN_SDK__ for React +
...
(function () {
  ...
  const SDK = window.__NIA_PLUGIN_SDK__;
  if (!SDK) return;
  ...
  const COLUMN_DOT = {
    triage: "nia-kanban-dot-triage",
    todo: "nia-kanban-dot-todo",
    ready: "nia-kanban-dot-ready",
    running: "nia-kanban-dot-running",
    blocked: "nia-kanban-dot-blocked",
    done: "nia-kanban-dot-done",
    archived: "nia-kanban-dot-archived",
  };
  ...
  const MIME_TASK = "text/x-nia-task";
  ...
  const LS_BOARD_KEY = "nia.kanban.selectedBoard";
  ...
  function renderMarkdown(src) {
    ...
    html = html.replace(/\u0000CODE(\d+)\u0000/g, (_m, i) =>
      `<pre class="nia-kanban-md-code"><code>${escapeHtml(blocks[Number(i)])}</code></pre>`,
    );
    return html;
  }
  ...
  function MarkdownBlock(props) {
    ...
    if (!enabled) {
      return h("pre", { className: "nia-kanban-pre" }, props.source || "");
    }
    return h("div", {
      className: "nia-kanban-md",
  ...
  // standard `drop` event and our `nia-kanban:drop` event.
  // -------------------------------------------------------------------------
  ...
  function attachTouchDrag(el, taskId) {
    ...
    function onDown(e) {
      ...
      proxy.classList.add("nia-kanban-touch-proxy");
      ...
      function move(ev) {
        ...
        if (col !== lastTarget) {
          if (lastTarget) lastTarget.classList.remove("nia-kanban-column--drop");
          if (col) col.classList.add("nia-kanban-column--drop");
          lastTarget = col;
        }
      }
      function up() {
        ...
        if (lastTarget) {
          lastTarget.classList.remove("nia-kanban-column--drop");
          const status = lastTarget.getAttribute("data-kanban-column");
          lastTarget.dispatchEvent(new CustomEvent("nia-kanban:drop", {
  ...
  function KanbanPage() {
    ...
    useEffect(function () {
      ...
      function openWs() {
        ...
        const token = window.__NIA_SESSION_TOKEN__ || "";
    ...
    return h(ErrorBoundary, null,
      h("div", { className: "nia-kanban flex flex-col gap-4" },
        h(BoardSwitcher, {
          board: board,
          boardList: boardList,
  ...
  function BoardSwitcher(props) {
    ...
    if (!shouldShow) {
      return h("div", {
        className: "nia-kanban-boardswitcher-compact",
    ...
    return h("div", { className: "nia-kanban-boardswitcher" },
      h("div", { className: "nia-kanban-boardswitcher-inner" },
  ...
  function NewBoardDialog(props) {
    ...
    return h("div", {
      className: "nia-kanban-dialog-backdrop",
      onClick: function (e) { if (e.target === e.currentTarget) props.onCancel(); },
    },
      h("form", {
        className: "nia-kanban-dialog",
        onSubmit: onSubmit,
      },
        h("div", { className: "nia-kanban-dialog-title" }, "New board"),
        ...
        h("div", { className: "nia-kanban-dialog-actions" },
          h(Button, {
            type: "button",
  ...
  function BulkActionBar(props) {
    ...
    return h("div", { className: "nia-kanban-bulk" },
      h("span", { className: "nia-kanban-bulk-count" },
      ...
      h("div", { className: "nia-kanban-bulk-reassign" },
        h(Select, {
          value: assignee,
  ...
  function BoardColumns(props) {
    return h("div", { className: "nia-kanban-columns" },
  ...
  function Column(props) {
    ...
    useEffect(function () {
      ...
      el.addEventListener("nia-kanban:drop", onTouchDrop);
      return function () { el.removeEventListener("nia-kanban:drop", onTouchDrop); };
    ...
    return h("div", {
      ...
      className: cn(
        "nia-kanban-column",
        dragOver ? "nia-kanban-column--drop" : "",
      ),
      onDragOver: handleDragOver,
      onDragLeave: handleDragLeave,
      onDrop: handleDrop,
    },
      h("div", { className: "nia-kanban-column-header" },
        h("span", { className: cn("nia-kanban-dot", COLUMN_DOT[props.column.name]) }),
        h("span", { className: "nia-kanban-column-label" },
          COLUMN_LABEL[props.column.name] || props.column.name),
        h("span", { className: "nia-kanban-column-count" },
          props.column.tasks.length),
        h("button", {
          type: "button",
          className: "nia-kanban-column-add",
          title: "Create task in this column",
          onClick: function () { setShowCreate(function (v) { return !v; }); },
        }, showCreate ? "×" : "+"),
      ),
      h("div", { className: "nia-kanban-column-sub" },
      ...
      h("div", { className: "nia-kanban-column-body" },
        props.column.tasks.length === 0
          ? h("div", { className: "nia-kanban-empty" }, "— no tasks —")
          : lanes
            ? lanes.map(function (lane) {
                return h("div", { key: lane.assignee, className: "nia-kanban-lane" },
                  h("div", { className: "nia-kanban-lane-head" },
                    h("span", { className: "nia-kanban-lane-name" }, lane.assignee),
                    h("span", { className: "nia-kanban-lane-count" }, lane.tasks.length),
                  ),
  ...
  function stalenessClass(task) {
    ...
    if (age >= tier.red)   return "nia-kanban-card--stale-red";
    if (age >= tier.amber) return "nia-kanban-card--stale-amber";
    return "";
  }
  ...
  function TaskCard(props) {
    ...
    return h("div", {
      ...
      className: cn(
        "nia-kanban-card",
        props.selected ? "nia-kanban-card--selected" : "",
        stalenessClass(t),
      ),
      draggable: true,
      ...
      h(Card, null,
        h(CardContent, { className: "nia-kanban-card-content" },
          h("div", { className: "nia-kanban-card-row" },
            h("input", {
              type: "checkbox",
              className: "nia-kanban-card-check",
              checked: props.selected,
              onChange: handleCheckbox,
              onClick: function (e) { e.stopPropagation(); },
              title: "Select for bulk actions",
            }),
            h("span", { className: "nia-kanban-card-id" }, t.id),
            t.priority > 0
              ? h(Badge, { className: "nia-kanban-priority" }, `P${t.priority}`)
              : null,
            t.tenant
              ? h(Badge, { variant: "outline", className: "nia-kanban-tag" }, t.tenant)
              : null,
            progress
              ? h("span", {
                  className: cn(
                    "nia-kanban-progress",
                    progress.done === progress.total ? "nia-kanban-progress--full" : "",
                  ),
                  title: `${progress.done} of ${progress.total} child tasks done`,
                }, `${progress.done}/${progress.total}`)
              : null,
          ),
          h("div", { className: "nia-kanban-card-title" }, t.title || "(untitled)"),
          h("div", { className: "nia-kanban-card-row nia-kanban-card-meta" },
            t.assignee
              ? h("span", { className: "nia-kanban-assignee" }, "@", t.assignee)
              : h("span", { className: "nia-kanban-unassigned" }, "unassigned"),
            t.comment_count > 0
              ? h("span", { className: "nia-kanban-count" }, "💬 ", t.comment_count)
              : null,
            t.link_counts && (t.link_counts.parents + t.link_counts.children) > 0
              ? h("span", { className: "nia-kanban-count" },
                  "↔ ", t.link_counts.parents + t.link_counts.children)
              : null,
            h("span", { className: "nia-kanban-ago" },
  ...
  function InlineCreate(props) {
    ...
    return h("div", { className: "nia-kanban-inline-create" },
      h(Input, {
        value: title,
  ...
  function TaskDrawer(props) {
    ...
    return h("div", { className: "nia-kanban-drawer-shade", onClick: props.onClose },
      h("div", {
        className: "nia-kanban-drawer",
        onClick: function (e) { e.stopPropagation(); },
      },
        h("div", { className: "nia-kanban-drawer-head" },
          h("span", { className: "text-xs text-muted-foreground" }, props.taskId),
          h("button", {
            type: "button",
            onClick: props.onClose,
            className: "nia-kanban-drawer-close",
            title: "Close (Esc)",
          }, "×"),
        ),
        ...
        data ? h("div", { className: "nia-kanban-drawer-comment-row" },
          h(Input, {
            value: newComment,
  ...
  function TaskDetail(props) {
    ...
    return h("div", { className: "nia-kanban-drawer-body" },
      h("div", { className: "nia-kanban-drawer-title" },
        h("span", { className: cn("nia-kanban-dot", COLUMN_DOT[t.status]) }),
        props.editing
          ? h(TitleEditor, {
              initial: t.title || "",
          ...
          : h("span", {
              className: "nia-kanban-drawer-title-text",
              title: "Click to edit",
              onClick: function () { props.setEditing(true); },
            }, t.title || "(untitled)"),
      ),
      h("div", { className: "nia-kanban-drawer-meta" },
      ...
      t.result ? h("div", { className: "nia-kanban-section" },
        h("div", { className: "nia-kanban-section-head" }, "Result"),
        h(MarkdownBlock, { source: t.result, enabled: props.renderMarkdown }),
      ) : null,
      h("div", { className: "nia-kanban-section" },
        h("div", { className: "nia-kanban-section-head" }, `Comments (${comments.length})`),
        comments.length === 0
          ? h("div", { className: "text-xs text-muted-foreground" }, "— no comments —")
          : comments.map(function (c) {
              return h("div", { key: c.id, className: "nia-kanban-comment" },
                h("div", { className: "nia-kanban-comment-head" },
                  h("span", { className: "nia-kanban-comment-author" }, c.author || "anon"),
                  h("span", { className: "nia-kanban-comment-ago" },
      ...
      h("div", { className: "nia-kanban-section" },
        h("div", { className: "nia-kanban-section-head" }, `Events (${events.length})`),
        events.slice().reverse().slice(0, 20).map(function (e) {
          return h("div", { key: e.id, className: "nia-kanban-event" },
            h("span", { className: "nia-kanban-event-kind" }, e.kind),
            h("span", { className: "nia-kanban-event-ago" },
              timeAgo ? timeAgo(e.created_at) : ""),
            e.payload
              ? h("code", { className: "nia-kanban-event-payload" },
  ...
  function RunHistorySection(props) {
    ...
    return h("div", { className: "nia-kanban-section" },
      h("div", { className: "nia-kanban-section-head-row" },
        h("span", { className: "nia-kanban-section-head" },
          `Run history (${runs.length})`),
        !showAll
          ? h("button", {
              type: "button",
              onClick: function () { setExpanded(true); },
              className: "nia-kanban-edit-link",
      ...
      visible.map(function (r) {
        const outcomeClass = r.ended_at
          ? `nia-kanban-run--${r.outcome || r.status || "ended"}`
          : "nia-kanban-run--active";
        return h("div", { key: r.id, className: cn("nia-kanban-run", outcomeClass) },
          h("div", { className: "nia-kanban-run-head" },
            h("span", { className: "nia-kanban-run-outcome" },
              r.ended_at ? (r.outcome || r.status || "ended") : "active"),
            h("span", { className: "nia-kanban-run-profile" },
              r.profile ? `@${r.profile}` : "(no profile)"),
            h("span", { className: "nia-kanban-run-elapsed" }, fmtElapsed(r)),
            h("span", { className: "nia-kanban-run-ago" },
              timeAgo ? timeAgo(r.started_at) : ""),
          ),
          r.summary
            ? h("div", { className: "nia-kanban-run-summary" }, r.summary)
            : null,
          r.error
            ? h("div", { className: "nia-kanban-run-error" }, r.error)
            : null,
          r.metadata
            ? h("code", { className: "nia-kanban-run-meta" },
  ...
  function WorkerLogSection(props) {
    ...
    if (state.loading) {
      ...
      body = h("pre", { className: "nia-kanban-pre nia-kanban-log" },
        data.content || "(empty)");
    }
  ...
  function MetaRow(props) {
    return h("div", { className: "nia-kanban-meta-row" },
      h("span", { className: "nia-kanban-meta-label" }, props.label),
      h("span", { className: "nia-kanban-meta-value" }, props.value),
    );
  }
  ...
  function TitleEditor(props) {
    ...
    return h("div", { className: "nia-kanban-edit-row" },
      h(Input, {
  ...
  function AssigneeEditor(props) {
    ...
    if (!editing) {
      return h("div", { className: "nia-kanban-meta-row" },
        h("span", { className: "nia-kanban-meta-label" }, "Assignee"),
        h("span", {
          className: "nia-kanban-meta-value nia-kanban-editable",
  ...
  function PriorityEditor(props) {
    ...
    if (!editing) {
      return h("div", { className: "nia-kanban-meta-row" },
        h("span", { className: "nia-kanban-meta-label" }, "Priority"),
        h("span", {
          className: "nia-kanban-meta-value nia-kanban-editable",
          onClick: function () { setEditing(true); },
          title: "Click to edit",
  ...
  function BodyEditor(props) {
    ...
    return h("div", { className: "nia-kanban-section" },
      h("div", { className: "nia-kanban-section-head-row" },
        h("span", { className: "nia-kanban-section-head" }, "Description"),
        editing
  ...
  function DependencyEditor(props) {
    ...
    return h("div", { className: "nia-kanban-section" },
      h("div", { className: "nia-kanban-section-head" }, "Dependencies"),
      h("div", { className: "nia-kanban-deps-row" },
        h("span", { className: "nia-kanban-deps-label" }, "Parents:"),
        h("div", { className: "nia-kanban-deps-chips" },
          (links.parents || []).length === 0
            ? h("span", { className: "nia-kanban-deps-empty" }, "none")
            : (links.parents || []).map(function (id) {
                return h("span", { key: id, className: "nia-kanban-dep-chip" },
                  id,
                  h("button", {
                    type: "button",
                    className: "nia-kanban-dep-chip-x",
      ...
      h("div", { className: "nia-kanban-deps-row" },
        h("span", { className: "nia-kanban-deps-label" }, "Children:"),
        h("div", { className: "nia-kanban-deps-chips" },
  ...
  function StatusActions(props) {
    ...
    return h("div", { className: "nia-kanban-actions" },
  ...
  if (window.__NIA_PLUGINS__ && typeof window.__NIA_PLUGINS__.register === "function") {
    window.__NIA_PLUGINS__.register("kanban", KanbanPage);
  }
})();
