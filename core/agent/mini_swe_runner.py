#!/usr/bin/env python3
"""
SWE Runner with NIA Trajectory Format

A runner that uses nia-agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the nia-agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses nia-agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in NIA format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches nia-agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using nia-agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with NIA Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses nia-agent's built-in execution environments
    and outputs trajectories in nia-agent format.
    """
    ...
    def _convert_to_nia_format(
        ...
        """
        Convert internal message format to NIA trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to NIA trajectory format
        trajectory = self._convert_to_nia_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with NIA trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with NIA Trajectory Format")
    print("=" * 60)
