#!/usr/bin/env python3
"""Build the NIA Skills Index — a centralized JSON catalog of all skills.
...
`nia skills search/install` can use it without hitting the GitHub API.
...
# Ensure NIA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building NIA Skills Index...", flush=True)
