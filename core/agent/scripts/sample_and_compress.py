...
DEFAULT_DATASETS = [
    ...
    "NousResearch/nia-agent-megascience-sft1",
    "NousResearch/nia-agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/nia-agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-nia-agent"
]
