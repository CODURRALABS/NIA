#!/usr/bin/env python3
"""Build the NIA Model Catalog — a centralized JSON manifest of curated models.
...
NIA CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a NIA release.
...
# Ensure NIA_HOME is set for imports that touch it at module level.
os.environ.setdefault("NIA_HOME", os.path.join(os.path.expanduser("~"), ".nia"))

from nia_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "nia-agent repo",
            "docs": "Local Sovereign Hub/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
